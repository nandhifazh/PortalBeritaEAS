...
import com.example.portalberitaeas.NewsAdapter;
import com.example.portalberitaeas.NewsAPI;
import com.example.portalberitaeas.ModelNews;
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(SportNewsActivity.this, "Gagal menampilkan data!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(ANError anError) {
                        progressDialog.dismiss();
                        Toast.makeText(SportNewsActivity.this, "Tidak ada jaringan internet!", Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void showNews() {
        newsAdapter = new NewsAdapter(SportNewsActivity.this, modelNews, this);
        rvSportNews.setAdapter(newsAdapter);
    }

    @Override
    public void onSelected(ModelNews mdlNews) {
        startActivity(new Intent(SportNewsActivity.this, OpenNewsActivity.class).putExtra("url", mdlNews.getUrl()));
    }
